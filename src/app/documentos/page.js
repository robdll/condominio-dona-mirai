                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {documento.url ? (
                          <Link
                            ...
                            className="inline-flex items-center px-4 py-2 bg-brandBtn hover:bg-brandBtnHover text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
                          >
